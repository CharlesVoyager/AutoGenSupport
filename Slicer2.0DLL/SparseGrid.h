...
//
//	template <>
//	struct hash<cura::Point> : public unary_function<cura::Point, size_t>
//	{
//		size_t operator()(const cura::Point& value) const
//		{
//			return 0;
//		}
//	};
...
//
//	template <>
//	struct equal_to<cura::Point> : public unary_function<cura::Point, bool>
//	{
//		bool operator()(const cura::Point& x, const cura::Point& y) const
//		{
//			return false;
//		}
//	};
...
protected:
	...
	////using GridMap = std::unordered_map<GridPoint, Elem>;
...
SGI_TEMPLATE
typename SGI_THIS::GridPoint SGI_THIS::toLowerCorner(const GridPoint& location)  const
{
    return Point(toLowerCoord(location.X), toLowerCoord(location.Y));
}

SGI_TEMPLATE
typename SGI_THIS::grid_coord_t SGI_THIS::toLowerCoord(const grid_coord_t& grid_coord)  const
{
    // This mapping via truncation results in the cells with
    // GridPoint.x==0 being twice as large and similarly for
    // GridPoint.y==0.  This doesn't cause any incorrect behavior,
