...
namespace std
{
	...
	template <>
	struct hash<cura::ListPolyIt> : public unary_function<cura::ListPolyIt, size_t>
	{
		size_t operator()(const cura::ListPolyIt& value) const
		{
			return 0;
		}
	};
	...
	template <>
	struct equal_to<cura::ListPolyIt> : public unary_function<cura::ListPolyIt, bool>
	{
		bool operator()(const cura::ListPolyIt& x, const cura::ListPolyIt& y) const
		{
			return false;
		}
	};
