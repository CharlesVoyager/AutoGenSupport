...
public:
	...
	int z = -1;
	Polygons polygons;
	Polygons polygons_transfer;
	Polygons openPolylines;
    std::vector<PolygonsPart> layerparts;
	...
	*/
	...
	void offsetPolygons(const Mesh* mesh);
	void transformPolygons(ProjectiveMapping* projectiveMapping);
    void makeLayerpars(const int layerIdx);
...
public:
	...
	//Slicer(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName, std::vector<Point> srcPoints, std::vector<Point> disPoints);
	Slicer(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName, std::vector<Point> srcPoints, std::vector<Point> disPoints, PERCENTAGE_CALLBACK callback);
	/*!
	...
	*/
	...
	BOOL projectiveMapping(std::vector<SlicerLayer>& layers_ref, std::vector<Point> srcPoints, std::vector<Point> disPoints);
	void savePartsSVG(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName);
    void saveMeshIdxSVG(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName);
	void savePolygonsSVG(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName);
	void saveMeshesSVG(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName);
	void saveSegmentsSVG(Mesh* mesh, int initial, int thickness, int slice_layer_count, LPCWSTR fileName);
};
